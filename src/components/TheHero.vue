...
import backgroundImage from '@/assets/the_hero_background.png'
</script>
...
.hero::before {
  ...
  position: absolute;
  inset: 0;
  background: rgba(73, 73, 72, 0.85); /* Overlay escuro */
}
...
.hero-icons i { color: #DACBA9; margin-right: 5px; }
